...
|  6   | Turning circuits into computers<br>[building computer handout](misc/architecture-intro-handout.pdf)<br>[automatic computer](slides/arch-automatic-computer.pdf) | | <br>**Wednesday 10/6** Sequential Circuits Lab<br>**Thursday, October 7** Midterm Exam 1 (during lab) |

...
|  8   | Unconditional branch (jump)<br>[jump](slides/arch-jump.pdf)<br><br>Assembly programming constructs<br>[conditionals (if statements)](slides/assembly-conditionals.pdf)<br>[loops](slides/assembly-loops.pdf)<br><br>Branch microarchitecture<br><br>Memory load/store<br>[memory instructions](slides/arch-memory.pdf) | [Memory handout](./misc/assembly-and-memory.pdf) | **Tuesday 10/19** [Assembly Intro Lab](https://www.prairielearn.org/pl/course_instance/128859/assessment/2314402) <br>**Thursday 10/21** [Homework 3](https://www.prairielearn.org/pl/course_instance/128859/assessment/2314338) |
